...
def process_damage_reports(db_path: str, csv_path: str, schema: str) -> None:
    """
    ...
    try:
        ...
        pipeline.process_csv(csv_path, "storm_damage", "storm_damage_invalid")
        ...
        logger.info(
            f"Processing complete. Valid records: {valid_count}, "
